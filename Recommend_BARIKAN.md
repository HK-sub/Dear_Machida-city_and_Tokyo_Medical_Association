...
- [12480MLC](https://www.google.com/search?q=12480MLC&oq=12&aqs=chrome.0.69i59l3j69i57j69i60l3j69i61.2395j0j9&sourceid=chrome&ie=UTF-8)
  ...
  - アルミボディにカーボン製ブレード（刃）。モーター出力は固定で7,200 spm((メーカーのページには、7,200rpmの「高速回転モーター」と書いてあった。spmはあくまで一分当たりのストローク数であり回転数ではないはずなのだが、一般的な工業用語とバリカンのspmは意味合いが違ってくるのだろうか。詳細は不明である。))。刈り高さは0.5mm～2.4mmの無段階調整機能付き。アタッチメントは無し。
